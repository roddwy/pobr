	...
	<div class="panel panel-default">
		...
		<div class="panel-body">
			...
			<div class="form-horizontal">				
				...
				<div class="form-group">
					{!! Form::label('user_id','Asesor a Designar :',['class'=>'col-sm-2 control-label']) !!}
					<div class="col-sm-10">
						{!! Form::select('user_id', $users, null, ['class'=>'form-control', 'placeholder'=>'Seleccione Asesor de Venta', 'required']) !!}
					</div>
				</div>
				<div class="form-group">
